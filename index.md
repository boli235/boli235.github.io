        ...
        <table border="0" width="100%" bgcolor="#f3f4f5">
          <tr>
            ...
            <td style="padding: 15px; word-break: break-all;">
              ...
              <br><br>
              <b> 价值总结 (So what)</b><br>
              凭借全栈开发的稳健控制系统， <b>机器人实现自动精准投篮</b>与<b>高动态防守对位</b>。项目已形成一套“高动态底盘+高精度射击”的控制方案，可直接转化应用于高性能移动作业机器人等领域。
              <br>
            </td>
          </tr>
        </table>
  ...
  <tr>
    ...
    <td width="55%" valign="top" style="word-break: break-all; padding-left: 10px;">
      ...
      <ul>
        ...
        <li><b>操控交互优化：</b> 开发 ADC 采样遥控系统，引入 <b>一阶低通滤波</b> 滤除硬件噪声，并设计 <b>S型曲线</b> 进行控制量映射，实现了高位爆发响应与中位精准微操的平衡。</li>
